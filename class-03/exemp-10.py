...
create_bar_chart(time_with_lock, max(time_with_lock, time_without_lock), "Com Sincronização",
color=Fore.RED)
create_bar_chart(time_without_lock, max(time_with_lock, time_without_lock), "Sem Sincronização",
color=Fore.GREEN)
...
print(Fore.YELLOW + "AVISO: O overhead de sincronização é significativo!" +
Style.RESET_ALL)
